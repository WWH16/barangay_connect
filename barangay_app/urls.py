...
urlpatterns = [
    ...
    path('staff/edit-report/<str:report_type>/<int:report_id>/', views.edit_report, name='edit_report'),
    path('staff/delete-report/<str:report_type>/<int:report_id>/', views.delete_report, name='delete_report'),
